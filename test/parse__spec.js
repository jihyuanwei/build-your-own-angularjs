...
describe('parse', function() {
  ...
  it('can parse filer chain expressions', function() {
    parse = createInjector(['ng', function ($filterProvider) {
      $filterProvider.register('upcase', function () {
        return function (s) {
  ...
  it('can pass several addtional arguments to filters', function() {
    parse = createInjector(['ng', function($filterProvider) {
  ...
  it('marks arrays constant when elements are constants', function () {
