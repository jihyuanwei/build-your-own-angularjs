...
describe('$q', function () {
  ...
  it('can reject a deferred', function() {
    ...
    d.promise.then(fulfilledSpy, rejectSpy);
  ...
  it('does not require a failure handler each times', function() {
    var d = $q.defer();
  ...
  it('invokes a finally handler when fulfilled', function() {
    ...
    //check thath finally callback did not receive any arguments
  ...
  it('resolve to orig value when nested promise resolve', function() {
    var d = $q.defer();
  ...
  it("rejects when nested promise rejects finally", function() {
    var d = $q.defer();
  ...
  it('transforms progress through handlres', function() {
    var d = $q.defer();
    var progressSpy = jasmine.createSpy();
  ...
  describe('$$q', function() {
    ...
    it('uses deferred that do not resolve at digest', function() {
      var d = $$q.defer();
      var fulfilledSpy = jasmine.createSpy();
      d.promise.then(fulfilledSpy);
      d.resolve('ok');
    ...
    it('uses deferred that resolve later', function() {
      var d = $$q.defer();
      var fulfilledSpy = jasmine.createSpy();
      d.promise.then(fulfilledSpy);
      d.resolve('ok');
