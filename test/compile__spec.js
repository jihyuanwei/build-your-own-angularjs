...
describe('$compile', function() {
  ...
  describe('attributes', function() {
    ...
    it('allows settting attributes', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('settting attributes to DOM', function() {
      registerAndCompile(
        'myDirective',
        '<my-directive attr="true"></my-directive>',
        function(element, attrs) {
    ...
    it('does not use ng-attr- prefix in denormalizes attribute name', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('supports valus for class directive attributes', function () {
      registerAndCompile(
        'myDirective',
  ...
  describe('linking', function() {
    ...
    it('stablizes node list during linking', function() {
      var givenElements = []; 
      var injector = makeInjectorWithDirectives('myDirective', function () {
        return {
          link: function(scope, element, attrs) {
    ...
    it('give inherited scope to all directives on element', function() {
      var givenScope; 
      var injector = makeInjectorWithDirectives({
        myDirective: function () {
          return {
    ...
    it('creates an isolate scope when request', function() {
      var givenScope; 
      var injector = makeInjectorWithDirectives('myDirective', function () {
        return {
          scope: {},
    ...
    it('does not share isolate scope other request', function() {
      var givenScope; 
      var injector = makeInjectorWithDirectives({
        myDirective: function () {
          return {
    ...
    it('does not isolate scope on child elements', function() {
      var givenScope; 
      var injector = makeInjectorWithDirectives({
        myDirective: function () {
          return {
    ...
    it('does not watch optinal missing isolated scope expressions', function() { 
      var givenScope;
      var injector = makeInjectorWithDirectives('myDirective', function () {
        return {
          scope: {
    ...
    it('allow aliasing two-way expression attribute on isolated scope', function() { 
      var givenScope;
      var injector = makeInjectorWithDirectives('myDirective', function () {
        return {
          scope: {
    ...
    it('allows assigning to two-way scope expression', function() {
      var isolateScope;
      var injector = makeInjectorWithDirectives('myDirective', function () {
        return {
          scope: {
