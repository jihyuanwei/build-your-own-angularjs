...
describe("Scope", function () {
  ...
  describe("$digest", function () {
    ...
    it("calls the listener function when the watched value changes", function () {
      ...
      //counter increment during first $digest
      scope.$digest();
    ...
    it("executes $evalAsync'ed function later in the same cycle", function() {
      ...
      //the asyncfunc are evaluted in same digest, but after the listen function finish
      scope.$digest();
    ...
    it("execute $evalAsync'ed functions even when not dirty", function() {
      scope.aValue = [1, 2, 3];
    ...
    //$applyAsync is used outside digest loop
    ...
    it("runs a $$postDigest funtion after each digest", function() {
      scope.counter = 0;
    ...
    it("doesn't include $$postDigest in the digest", function() {
    ...
    it("allows watch destroy self", function() {
      scope.aValue = 'abc';
    ...
    it("allows watch destroy another", function() {
      scope.aValue = 'abc';
      scope.counter = 0;
    ...
    it("allows watch destroy serveral $watches during digest", function() {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe("$watchGroup", function() {
    ...
    it('uses different array of old and new values on subsequent runs', function() {
      var gotNewValues, gotOldValues;
  ...
  describe("inheritance", function() {
    it("inherits the parent's properties", function() {
      ...
      expect(child.aValue).toEqual([1, 3, 4]);
    });
    ...
    it("inherits the parent's properties whenever", function() {
      var parent = new Scope();
    ...
    it("can mainpulate a parent scope's property", function() {
      var parent = new Scope();
      ...
      expect(parent.aValue).toEqual([1, 3, 4, 5]);
      expect(child.aValue).toEqual([1, 3, 4, 5]);
    });
    ...
    it("keep record of its children", function() {
      var parent = new Scope();
    ...
    it("executes $postAsync functions on isolated scopes", function() {
      var parent = new Scope();
      var child = parent.$new(true);
  ...
  describe("$watchCollections", function() {
    ...
    it("notices when an attribute is added to an object", function () {
      scope.counter = 0;
      scope.obj = { a: 1 }; scope.$watchCollection(
        function (scope) { return scope.obj; },
        function (newValue, oldValue, scope) {
          scope.counter++;
        }
  ...
  describe("Events", function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it("passes the same event object to each listeners on" + method, function() {
        var listener1 = jasmine.createSpy();
        var listener2 = jasmine.createSpy();
        scope.$on('someEvent', listener1);
        scope.$on('someEvent', listener2);
      ...
      it("doesn't skip the next listener when removed on"+ method, function() {
        var deregister;
    ...
    //targetScope: event originated in
