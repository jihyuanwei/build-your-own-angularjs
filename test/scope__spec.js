...
describe('Scope', function () {
  ...
  describe('digest', function () {
    ...
    it('remove constants watches after first invocation', function() {
    ...
    it('accpets one-time watches', function() {
      var theValue;
    ...
    it('remove one-time watches after first invocation', function() {
      scope.aValue = 42;
  ...
  describe('$eval', function () {
    ...
    it('accpet expressions in $eval', function() {
  ...
  describe('$apply', function () {
    ...
    it('accpets expressions in $apply', function() {
  ...
  describe('$evalAsync', function () {
    ...
    it('accpets expressions in $evalAsync', function(done) {
      var called;
