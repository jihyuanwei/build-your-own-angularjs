...
describe('setupModuleLoader', function() {
  ...
  it('does not accept non-strings as injections tokens', function() {
    var module = window.angular.module('myModule', []);
    module.constant('a', 1);
    var injector = createInjector(['myModule']);
  ...
  it('invokes a function with given context', function() {
    var module = window.angular.module('myModule', []);
    module.constant('a', 1);
    var injector = createInjector(['myModule']);
  ...
  it('overrides dependecies with locals when invoking', function() {
    var module = window.angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  describe('annotate', function() {
    ...
    it('reuturns the array-style annotations of a function', function() {
      var injector = createInjector([]);
      var fn = ['a', 'b', function() {}];
    ...
    it('uses the prototypeof the constructor when instantiating', function() {
      function BaseType() {}
  ...
  it('notifies the user about circulr dependency', function() {
    var module = window.angular.module('myModule', []);
  ...
  it('inject another provider to a provider constructor function', function() {
    var module = window.angular.module('myModule', []);
  ...
  it('does not make values avaiable to config blocks', function() {
    var module = window.angular.module('myModule', []);
  ...
  it('inject service constructor with instances', function() {
    var module = window.angular.module('myModule', []);
